/*---------------------------------------------------------------
 * 作者：evesgf    创建时间：2016-8-3 13:53:11
 * 修改：evesgf    修改时间：2016-8-3 13:53:18
 *
 * 版本：V0.0.1
 * 
 * 描述：UI类型
...
namespace LarkFramework
{
    ...
    public abstract class UIPage
    {
        ...
        /// </summary>
        public static Func<string, UnityEngine.Object> delegateSyncLoadUI = null;
        public static Action<string, Action<UnityEngine.Object>> delegateAsyncLoadUI = null;
        ...
        /// <summary>
        /// Active this UI
        /// 当调用ShowPage时就会执行，执行顺序在Refresh前
        /// </summary>
